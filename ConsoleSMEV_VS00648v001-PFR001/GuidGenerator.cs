...
namespace ConsoleSMEV_VS00648v001_PFR001
{
    ...
    public static partial class GuidGenerator
    {
        ...
        // offset to move from 1/1/0001, which is 0-time for .NET, to gregorian 0-time of 10/15/1582 zone +3
        private static readonly DateTimeOffset CalendarStart = new DateTimeOffset(1582, 10, 15, 0, 0, 0, TimeSpan.FromHours(3));
        ...
        public static DateTimeOffset GetDateTimeOffset(Guid guid)
        {
            ...
            long ticks = timestamp + CalendarStart.Ticks;
        ...
        public static Guid GenerateTimeBasedGuid(DateTimeOffset dateTime, byte[] clockSequence, byte[] node)
        {
            ...
            long ticks = (dateTime - CalendarStart).Ticks;
